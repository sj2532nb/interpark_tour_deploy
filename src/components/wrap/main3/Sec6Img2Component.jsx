...
export default function Sec6Img2Component() {
    ...
    return (
        ...
        <div id='section4Child' className={`${showModal ? 'on' : ''}`} onClick={modalClose}>
            <div className="container">
                <div className="gap">
                    <div className="title blind">두짓 타니 괌 리조트</div>
                    <div className="content">
                        <div className="img-box">
                            <div className="left-img">
                            {
                                ...
                                <img onClick={() => onClickModal("../img/sub3/sec6img/2_1.jpg")} src="../img/sub3/sec6img/2_1.jpg" alt="" />
                            </div>
                            <div className="right-img">
                                <ul>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/2_2.jpg")} src="../img/sub3/sec6img/2_2.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/2_3.jpg")} src="../img/sub3/sec6img/2_3.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/2_4.jpg")} src="../img/sub3/sec6img/2_4.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/2_5.jpg")} src="../img/sub3/sec6img/2_5.jpg" alt="" /></li>
                                </ul>
                            </div>
                        </div>
