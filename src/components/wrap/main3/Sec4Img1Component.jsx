...
export default function Sec4Img1Component() {
                    ...
                    <div className="content">
                        <div className="img-box">
                            <div className="left-img">
                            {
                                ...
                                <img onClick={() => onClickModal("../img/sub3/sec4img/59bb1108_z.jpg")} src="../img/sub3/sec4img/59bb1108_z.jpg" alt="" />
                            </div>
                            <div className="right-img">
                                <ul>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec4img/e6f0e8f9_z.jpg")} src="../img/sub3/sec4img/e6f0e8f9_z.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec4img/a23f23d2_z.jpg")} src="../img/sub3/sec4img/a23f23d2_z.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec4img/d4e34377_z.jpg")} src="../img/sub3/sec4img/d4e34377_z.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec4img/dfff25bb_z.jpg")} src="../img/sub3/sec4img/dfff25bb_z.jpg" alt="" /></li>
                                </ul>
                            </div>
                        </div>
