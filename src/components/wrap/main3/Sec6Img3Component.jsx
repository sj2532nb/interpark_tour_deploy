...
export default function Sec6Img3Component() {
    ...
    return (
        ...
        <div id='section4Child' className={`${showModal ? 'on' : ''}`} onClick={modalClose}>
            <div className="container">
                <div className="gap">
                    <div className="title blind">하얏트 리젠시 괌</div>
                    <div className="content">
                        <div className="img-box">
                            <div className="left-img">
                            {
                                ...
                                <img onClick={() => onClickModal("../img/sub3/sec6img/3_1.jpg")} src="../img/sub3/sec6img/3_1.jpg" alt="" />
                            </div>
                            <div className="right-img">
                                <ul>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/3_1.jpg")} src="../img/sub3/sec6img/3_1.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/3_2.jpg")} src="../img/sub3/sec6img/3_2.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/3_3.jpg")} src="../img/sub3/sec6img/3_3.jpg" alt="" /></li>
                                    <li><img onClick={() => onClickModal("../img/sub3/sec6img/3_4.jpg")} src="../img/sub3/sec6img/3_4.jpg" alt="" /></li>
                                </ul>
                            </div>
                        </div>
