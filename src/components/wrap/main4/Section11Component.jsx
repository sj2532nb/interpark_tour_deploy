...
export default function Section11Component({setViewProduct}){
    ...
    React.useEffect(()=>{
        ...
        .then((res)=>{
                if(res.status===200){
                    ...
                    setState({
                        ...state,
                        slide49: res.data.slide49,
                        n: res.data.slide49.length-6
                    })
                }
        })
        .catch((err)=>{
    ...
    React.useEffect(()=>{
        ...
        const $slide = $('#section11 .slide');
        const $prevBtn = $('#section11 .prev-btn');
        const $nextBtn = $('#section11 .next-btn');
        const $currentPage = $('#section11 .current-page');
        const $totalPage = $('#section11 .total-page');
        let cnt=0;
        let setId=0;
        ...
        function slidePage(){
            console.log(cnt);
            $currentPage.html(cnt+1===17? 1:(cnt+1===0? state.n:cnt+1));
    ...
    return (
        <section id="section11" className='section6-16'>
