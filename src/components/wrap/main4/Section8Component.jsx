...
export default function Section8Component({setViewProduct}){
    ...
    React.useEffect(()=>{
        ...
        .then((res)=>{
                if(res.status===200){
                    ...
                    setState({
                        ...state,
                        slide46: res.data.slide46,
                        n: res.data.slide46.length-6
                    })
                }
        })
        .catch((err)=>{
    ...
    React.useEffect(()=>{
        ...
        const $slideWrap = $('#section8-1 .slide-wrap');
        const $slide = $('#section8-1 .slide');
        const $prevBtn = $('#section8-1 .prev-btn');
        const $nextBtn = $('#section8-1 .next-btn');
        const $currentPage = $('#section8-1 .current-page');
        const $totalPage = $('#section8-1 .total-page');
        let cnt=0;
        let setId=0;
    ...
    return (
        <section id="section8-1" className='section6-16'>
