...
export default function Section12Component({setViewProduct}){
    ...
    React.useEffect(()=>{
        ...
        .then((res)=>{
                if(res.status===200){
                    ...
                    setState({
                        ...state,
                        slide4a: res.data.slide4a,
                        n: res.data.slide4a.length-6
                    })
                }
        })
        .catch((err)=>{
    ...
    React.useEffect(()=>{
        ...
        const $slide = $('#section12 .slide');
        const $prevBtn = $('#section12 .prev-btn');
        const $nextBtn = $('#section12 .next-btn');
        const $currentPage = $('#section12 .current-page');
        const $totalPage = $('#section12 .total-page');
        let cnt=0;
        let setId=0;
        ...
        function slidePage(){
            console.log(cnt);
            $currentPage.html(cnt+1===11? 1:(cnt+1===0? state.n:cnt+1));
    ...
    return (
        <section id="section12" className='section6-16'>
