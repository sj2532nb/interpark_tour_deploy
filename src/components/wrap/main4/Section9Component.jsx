...
export default function Section9Component({setViewProduct}){
    ...
    React.useEffect(()=>{
        ...
        const $slideWrap = $('#section9-1 .slide-wrap');
        const $slide = $('#section9-1 .slide');
        const $prevBtn = $('#section9-1 .prev-btn');
        const $nextBtn = $('#section9-1 .next-btn');
        const $currentPage = $('#section9-1 .current-page');
        const $totalPage = $('#section9-1 .total-page');
        let cnt=0;
        let setId=0;
    ...
    return (
        <section id="section9-1" className='section6-16'>
