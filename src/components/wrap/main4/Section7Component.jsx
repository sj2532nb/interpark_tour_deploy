...
export default function Section7Component({setViewProduct}){
    ...
    React.useEffect(()=>{
        ...
        .then((res)=>{
                if(res.status===200){
                    ...
                    setState({
                        ...state,
                        slide45: res.data.slide45,
                        n:res.data.slide45.length-6
                    })
                }
        })
        .catch((err)=>{
    ...
    React.useEffect(()=>{
        ...
        const $slideWrap = $('#section7-1 .slide-wrap');
        const $slide = $('#section7-1 .slide');
        const $prevBtn = $('#section7-1 .prev-btn');
        const $nextBtn = $('#section7-1 .next-btn');
        const $currentPage = $('#section7-1 .current-page');
        const $totalPage = $('#section7-1 .total-page');
        let cnt=0;
        let setId=0;
        ...
        function slidePage(){
            console.log(cnt);
            $currentPage.html(cnt+1===13? 1:(cnt+1===0? state.n:cnt+1));
    ...
    return (
        <section id="section7-1" className='section6-16'>
            <div className="container">
                <div className="gap">
                    <div className="content">
                        <div className="left-box">
                            <div className="title">
                                <h2>실시간 국내 인기 BEST 상품</h2>
