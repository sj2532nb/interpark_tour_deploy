    ...
    return (
        <section id="section10">
            <div className="container">
                <div className="gap">
                    <div className="title">
                        <h3><img src="./img/service/titDomesticcovenant.gif" alt="" /></h3>
                    </div>
                    <div className="content">
                        ...
                        <div>
                            ...
                            <p>
                                이 약관은 주식회사 인터파크(이하 ‘당사’라 함)와 여행자가 체결한 국내여행계약의 세부이행 및 준수사항을 정함을 목적으로 합니다.
                            </p>
                            <h5><strong>2.</strong><em> 제2조(여행의 종류 및 정의)</em></h5>
                            <p>
                                여행의 종류와 정의는 다음과 같습니다.
                                <br />
                                1. 일반모집여행 : 당사가 수립한 여행조건에 따라 여행자를 모집하여 실시하는 여행.
                                <br />
                                2. 희 망 여 행 : 여행자가 희망하는 여행조건에 따라 당사가 실시하는 여행.
                                <br />
                            ...
                            <h5><strong>5.</strong><em> 제5조(계약체결 거절)</em></h5>
                            <p>
                            ...
                            <p>
                                당사는 여행자와 여행계약을 체결한 경우 계약서와 여행약관, 여행일정표(또는 여행설명서)를 각 1부씩 여행자에게 교부하고, 여행목적지에 관한 안전정보를 제공하여야 합니다. 또한 여행 출발 전 해당 여행지에 대한 안전정보가 변경된 경우에도 변경된 안전정보를 제공하여야 합니다.
                            </p>
                            ...
                            <h5><strong>9.</strong><em> 제9조(여행요금)</em></h5>
                            <p>
                            ...
                            <h5><strong>10.</strong><em> 제10조(여행조건의 변경요건 및 요금 등의 정산)</em></h5>
                            <p>
                            ...
                            <h5><strong>11.</strong><em> 제11조(여행자 지위의 양도)</em></h5>
                            <p>
                            ...
                            <h5><strong>12.</strong><em> 제12조(당사의 책임)</em></h5>
                            <p>
                            ...
                            <h5><strong>13.</strong><em> 제13조(여행출발 전 계약해제)</em></h5>
                            <p>
                            ...
                            <h5><strong>14.</strong><em> 제14조(최저행사인원 미 충족시 계약해제)</em></h5>
                            <p>
                            ...
                            <h5><strong>15.</strong><em> 제15조(여행출발 후 계약해지)</em></h5>
                            <p>
